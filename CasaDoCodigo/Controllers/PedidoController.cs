...
namespace CasaDoCodigo.Controllers
{
    public class PedidoController : Controller
    {
        ...
        public async Task<IActionResult> BuscaDeProdutos(BuscaDeProdutosViewModel buscaDeProdutosViewModel)
        {
            if (String.IsNullOrEmpty(buscaDeProdutosViewModel.pesquisa))
            {
                buscaDeProdutosViewModel = new BuscaDeProdutosViewModel(await produtoRepository.GetProdutos(), await CategoriaRepository.GetCategorias());
                return base.View(buscaDeProdutosViewModel);
            }
            buscaDeProdutosViewModel = new BuscaDeProdutosViewModel(await produtoRepository.GetProdutos(buscaDeProdutosViewModel.pesquisa), await CategoriaRepository.GetCategorias());
            return base.View(buscaDeProdutosViewModel);
